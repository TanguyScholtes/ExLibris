    ...
    <form method="POST" action="index.php?ressource=book&action=save" enctype="multipart/form-data">
        <p>
        ...
        <p>
            ...
            <select id="language_id" name="language_id">
                ...
                <?php foreach ( $data[ 'languages' ] as $language ): ?>
                    <option value="<?php echo $language[ 'id' ]; ?>"><?php echo $language[ 'full_name' ]; ?></option>
                <?php endforeach; ?>
            </select>
        ...
        <div>
            ...
            <select multiple id="authors_id" name="authors_id[]">
                ...
                <?php foreach ( $data[ 'authors' ] as $author ): ?>
                    <option value="<?php echo $author[ 'id' ]; ?>"><?php echo $author[ 'name' ] . ' ' . $author[ 'first_name' ]; ?></option>
                <?php endforeach; ?>
            </select>
